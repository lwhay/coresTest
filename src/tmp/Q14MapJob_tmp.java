...
public class Q14MapJob_tmp extends Configured implements Tool {
    ...
    public static class myReduce extends Reducer<IntWritable, IntWritable, NullWritable, IntWritable> {
        public void reduce(IntWritable key, Iterable<IntWritable> values, Context context)
            ...
            context.write(NullWritable.get(), new IntWritable(no));
        }
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "Q14MapJob_tmp");
        job.setJarByClass(Q14MapJob_tmp.class);
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new Q14MapJob_tmp(), args);
        System.exit(res);
    }
}
