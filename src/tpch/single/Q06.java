...
public class Q06 {
    public static void main(String[] args) throws IOException {
        ...
        filters[2] = new Q06_ShipdateFilter(args[3], args[4]); //l_shipdate
        filters[1] = new Q06_DiscountFilter(Float.parseFloat(args[5]), Float.parseFloat(args[6])); //l_discount
        filters[0] = new Q06_QuantityFilter(Float.parseFloat(args[7])); //l_quantity
